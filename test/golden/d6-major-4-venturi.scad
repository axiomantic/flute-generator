...
module complete_flute() {
    difference() {
        union() {
            ...
            if (tube_shell_mode == "staggered") {
                ...
                translate([0, 0, 126.38])
                    linear_extrude(height=46.32 + seam_lap)
                        hex_profile_2d();
            } else {
        ...
        translate([0, 10.32, 58.96]) rotate([-90, 0, 0]) {
            hull() {
        ...
        // Solid self-supporting donut chimney pad embedded 0.5mm into the front wall face
        translate([0, 10.32, 69.36]) rotate([-90, 0, 0]) {
            hull() {
                cylinder(d=20.20, h=0.5, $fn=24);
                translate([0, 0, 2.50]) cylinder(d=14.60, h=0.8, $fn=24);
            }
        ...
        // Solid self-supporting donut chimney pad embedded 0.5mm into the front wall face
        translate([0, 10.32, 79.36]) rotate([-90, 0, 0]) {
            hull() {
                cylinder(d=20.20, h=0.5, $fn=24);
                translate([0, 0, 2.50]) cylinder(d=14.60, h=0.8, $fn=24);
            }
        ...
        // Solid self-supporting donut chimney pad embedded 0.5mm into the front wall face
        translate([0, 10.32, 152.50]) rotate([-90, 0, 0]) {
            hull() {
                cylinder(d=20.20, h=0.5, $fn=24);
                translate([0, 0, 2.50]) cylinder(d=14.60, h=0.8, $fn=24);
            }
        ...
        // Tone holes
        translate([0, 0, 58.96]) rotate([-90, 0, 0]) cylinder(d=8.00, h=35.60, center=false, $fn=24);
        translate([0, 0, 69.36]) rotate([-90, 0, 0]) cylinder(d=8.00, h=35.60, center=false, $fn=24);
        translate([0, 0, 79.36]) rotate([-90, 0, 0]) cylinder(d=8.00, h=35.60, center=false, $fn=24);
        translate([0, 0, 152.50]) rotate([-90, 0, 0]) cylinder(d=8.00, h=35.60, center=false, $fn=24);
    }
}
