    ...
    difference() {
        union() {
            ...
            if (tube_shell_mode == "staggered") {
                ...
                translate([0, 0, 479.83])
                    linear_extrude(height=197.78 + seam_lap)
                        hex_profile_2d();
            } else {
        ...
        translate([0, 13.79, 148.94]) rotate([-90, 0, 0]) {
            hull() {
                cylinder(d=19.20, h=0.5, $fn=24);
                translate([0, 0, 2.50]) cylinder(d=13.60, h=0.8, $fn=24);
            }
            translate([0, 0, 3.30]) rotate_extrude($fn=24) translate([5.15, 0]) circle(d=2.64, $fn=16);
        }
        // Solid self-supporting donut chimney pad embedded 0.5mm into the front wall face
        translate([0, 13.79, 210.17]) rotate([-90, 0, 0]) {
            hull() {
                cylinder(d=19.20, h=0.5, $fn=24);
                translate([0, 0, 2.50]) cylinder(d=13.60, h=0.8, $fn=24);
            }
        ...
        // Solid self-supporting donut chimney pad embedded 0.5mm into the front wall face
        translate([0, 13.79, 226.62]) rotate([-90, 0, 0]) {
            hull() {
                cylinder(d=19.20, h=0.5, $fn=24);
                translate([0, 0, 2.50]) cylinder(d=13.60, h=0.8, $fn=24);
            }
        ...
        // Solid self-supporting donut chimney pad embedded 0.5mm into the front wall face
        translate([0, 13.79, 289.47]) rotate([-90, 0, 0]) {
            hull() {
                cylinder(d=19.20, h=0.5, $fn=24);
                translate([0, 0, 2.50]) cylinder(d=13.60, h=0.8, $fn=24);
            }
        ...
        // Solid self-supporting donut chimney pad embedded 0.5mm into the front wall face
        translate([0, 13.79, 335.32]) rotate([-90, 0, 0]) {
            hull() {
                cylinder(d=19.20, h=0.5, $fn=24);
                translate([0, 0, 2.50]) cylinder(d=13.60, h=0.8, $fn=24);
            }
        ...
        // Solid self-supporting donut chimney pad embedded 0.5mm into the front wall face
        translate([0, 13.79, 376.29]) rotate([-90, 0, 0]) {
            hull() {
                cylinder(d=19.20, h=0.5, $fn=24);
                translate([0, 0, 2.50]) cylinder(d=13.60, h=0.8, $fn=24);
            }
        ...
        // Solid self-supporting donut chimney pad embedded 0.5mm into the front wall face
        translate([0, 13.79, 625.54]) rotate([-90, 0, 0]) {
            hull() {
                cylinder(d=19.20, h=0.5, $fn=24);
                translate([0, 0, 2.50]) cylinder(d=13.60, h=0.8, $fn=24);
            }
        ...
        // Tone holes
        translate([0, 0, 148.94]) rotate([-90, 0, 0]) cylinder(d=7.00, h=43.60, center=false, $fn=24);
        translate([0, 0, 210.17]) rotate([-90, 0, 0]) cylinder(d=7.00, h=43.60, center=false, $fn=24);
        translate([0, 0, 226.62]) rotate([-90, 0, 0]) cylinder(d=7.00, h=43.60, center=false, $fn=24);
        translate([0, 0, 289.47]) rotate([-90, 0, 0]) cylinder(d=7.00, h=43.60, center=false, $fn=24);
        translate([0, 0, 335.32]) rotate([-90, 0, 0]) cylinder(d=7.00, h=43.60, center=false, $fn=24);
        translate([0, 0, 376.29]) rotate([-90, 0, 0]) cylinder(d=7.00, h=43.60, center=false, $fn=24);
        translate([0, 0, 625.54]) rotate([-90, 0, 0]) cylinder(d=7.00, h=43.60, center=false, $fn=24);
    }
}
