    ...
    difference() {
        union() {
            ...
            if (tube_shell_mode == "staggered") {
                ...
                translate([0, 0, 252.28])
                    linear_extrude(height=99.83 + seam_lap)
                        hex_profile_2d();
            } else {
        ...
        translate([0, 12.06, 92.06]) rotate([-90, 0, 0]) {
            hull() {
        ...
        // Solid self-supporting donut chimney pad embedded 0.5mm into the front wall face
        translate([0, 12.06, 102.06]) rotate([-90, 0, 0]) {
            hull() {
                cylinder(d=20.20, h=0.5, $fn=24);
                translate([0, 0, 2.50]) cylinder(d=14.60, h=0.8, $fn=24);
            }
        ...
        // Solid self-supporting donut chimney pad embedded 0.5mm into the front wall face
        translate([0, 12.06, 134.72]) rotate([-90, 0, 0]) {
            hull() {
                cylinder(d=20.20, h=0.5, $fn=24);
                translate([0, 0, 2.50]) cylinder(d=14.60, h=0.8, $fn=24);
            }
        ...
        // Solid self-supporting donut chimney pad embedded 0.5mm into the front wall face
        translate([0, 12.06, 159.90]) rotate([-90, 0, 0]) {
            hull() {
                cylinder(d=20.20, h=0.5, $fn=24);
                translate([0, 0, 2.50]) cylinder(d=14.60, h=0.8, $fn=24);
            }
        ...
        // Solid self-supporting donut chimney pad embedded 0.5mm into the front wall face
        translate([0, 12.06, 182.47]) rotate([-90, 0, 0]) {
            hull() {
                cylinder(d=20.20, h=0.5, $fn=24);
                translate([0, 0, 2.50]) cylinder(d=14.60, h=0.8, $fn=24);
            }
        ...
        // Solid self-supporting donut chimney pad embedded 0.5mm into the front wall face
        translate([0, 12.06, 322.73]) rotate([-90, 0, 0]) {
            hull() {
                cylinder(d=20.20, h=0.5, $fn=24);
                translate([0, 0, 2.50]) cylinder(d=14.60, h=0.8, $fn=24);
            }
        ...
        // Tone holes
        translate([0, 0, 92.06]) rotate([-90, 0, 0]) cylinder(d=8.00, h=39.60, center=false, $fn=24);
        translate([0, 0, 102.06]) rotate([-90, 0, 0]) cylinder(d=8.00, h=39.60, center=false, $fn=24);
        translate([0, 0, 134.72]) rotate([-90, 0, 0]) cylinder(d=8.00, h=39.60, center=false, $fn=24);
        translate([0, 0, 159.90]) rotate([-90, 0, 0]) cylinder(d=8.00, h=39.60, center=false, $fn=24);
        translate([0, 0, 182.47]) rotate([-90, 0, 0]) cylinder(d=8.00, h=39.60, center=false, $fn=24);
        translate([0, 0, 322.73]) rotate([-90, 0, 0]) cylinder(d=8.00, h=39.60, center=false, $fn=24);
    }
}
