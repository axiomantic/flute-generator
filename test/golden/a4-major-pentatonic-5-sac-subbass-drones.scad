    ...
    difference() {
        union() {
            ...
            if (tube_shell_mode == "staggered") {
                ...
                translate([0, 0, 633.05])
                    linear_extrude(height=173.56 + seam_lap)
                        hex_profile_2d();
            } else {
        ...
        translate([0, 12.06, 498.31]) rotate([-90, 0, 0]) {
            hull() {
        ...
        // Solid self-supporting donut chimney pad embedded 0.5mm into the front wall face
        translate([0, 12.06, 534.19]) rotate([-90, 0, 0]) {
            hull() {
                cylinder(d=19.20, h=0.5, $fn=24);
                translate([0, 0, 2.50]) cylinder(d=13.60, h=0.8, $fn=24);
            }
        ...
        // Solid self-supporting donut chimney pad embedded 0.5mm into the front wall face
        translate([0, 12.06, 586.96]) rotate([-90, 0, 0]) {
            hull() {
                cylinder(d=19.20, h=0.5, $fn=24);
                translate([0, 0, 2.50]) cylinder(d=13.60, h=0.8, $fn=24);
            }
        ...
        // Solid self-supporting donut chimney pad embedded 0.5mm into the front wall face
        translate([0, 12.06, 607.23]) rotate([-90, 0, 0]) {
            hull() {
                cylinder(d=19.20, h=0.5, $fn=24);
                translate([0, 0, 2.50]) cylinder(d=13.60, h=0.8, $fn=24);
            }
        ...
        // Solid self-supporting donut chimney pad embedded 0.5mm into the front wall face
        translate([0, 12.06, 649.58]) rotate([-90, 0, 0]) {
            hull() {
                cylinder(d=19.20, h=0.5, $fn=24);
                translate([0, 0, 2.50]) cylinder(d=13.60, h=0.8, $fn=24);
            }
        ...
        // Tone holes
        translate([0, 0, 498.31]) rotate([-90, 0, 0]) cylinder(d=7.00, h=39.60, center=false, $fn=24);
        translate([0, 0, 534.19]) rotate([-90, 0, 0]) cylinder(d=7.00, h=39.60, center=false, $fn=24);
        translate([0, 0, 586.96]) rotate([-90, 0, 0]) cylinder(d=7.00, h=39.60, center=false, $fn=24);
        translate([0, 0, 607.23]) rotate([-90, 0, 0]) cylinder(d=7.00, h=39.60, center=false, $fn=24);
        translate([0, 0, 649.58]) rotate([-90, 0, 0]) cylinder(d=7.00, h=39.60, center=false, $fn=24);
    }
}
