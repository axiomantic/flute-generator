    ...
    difference() {
        union() {
            ...
            if (tube_shell_mode == "staggered") {
                ...
                translate([0, 0, 1848.58])
                    linear_extrude(height=783.78 + seam_lap)
                        hex_profile_2d();
            } else {
        ...
        translate([0, 28.18, 620.46]) rotate([-90, 0, 0]) {
            hull() {
        ...
        // Solid self-supporting donut chimney pad embedded 0.5mm into the front wall face
        translate([0, 28.18, 665.13]) rotate([-90, 0, 0]) {
            hull() {
                cylinder(d=18.70, h=0.5, $fn=24);
                translate([0, 0, 2.50]) cylinder(d=13.10, h=0.8, $fn=24);
            }
        ...
        // Solid self-supporting donut chimney pad embedded 0.5mm into the front wall face
        translate([0, 28.18, 980.46]) rotate([-90, 0, 0]) {
            hull() {
                cylinder(d=18.70, h=0.5, $fn=24);
                translate([0, 0, 2.50]) cylinder(d=13.10, h=0.8, $fn=24);
            }
        ...
        // Solid self-supporting donut chimney pad embedded 0.5mm into the front wall face
        translate([0, 28.18, 1189.22]) rotate([-90, 0, 0]) {
            hull() {
                cylinder(d=18.70, h=0.5, $fn=24);
                translate([0, 0, 2.50]) cylinder(d=13.10, h=0.8, $fn=24);
            }
        ...
        // Solid self-supporting donut chimney pad embedded 0.5mm into the front wall face
        translate([0, 28.18, 1198.57]) rotate([-90, 0, 0]) {
            hull() {
                cylinder(d=18.70, h=0.5, $fn=24);
                translate([0, 0, 2.50]) cylinder(d=13.10, h=0.8, $fn=24);
            }
        ...
        // Solid self-supporting donut chimney pad embedded 0.5mm into the front wall face
        translate([0, 28.18, 1457.96]) rotate([-90, 0, 0]) {
            hull() {
                cylinder(d=18.70, h=0.5, $fn=24);
                translate([0, 0, 2.50]) cylinder(d=13.10, h=0.8, $fn=24);
            }
        ...
        // Solid self-supporting donut chimney pad embedded 0.5mm into the front wall face
        translate([0, 28.18, 1619.70]) rotate([-90, 0, 0]) {
            hull() {
                cylinder(d=18.70, h=0.5, $fn=24);
                translate([0, 0, 2.50]) cylinder(d=13.10, h=0.8, $fn=24);
            }
        ...
        // Tone holes
        translate([0, 0, 620.46]) rotate([-90, 0, 0]) cylinder(d=6.50, h=76.84, center=false, $fn=24);
        translate([0, 0, 665.13]) rotate([-90, 0, 0]) cylinder(d=6.50, h=76.84, center=false, $fn=24);
        translate([0, 0, 980.46]) rotate([-90, 0, 0]) cylinder(d=6.50, h=76.84, center=false, $fn=24);
        translate([0, 0, 1189.22]) rotate([-90, 0, 0]) cylinder(d=6.50, h=76.84, center=false, $fn=24);
        translate([0, 0, 1198.57]) rotate([-90, 0, 0]) cylinder(d=6.50, h=76.84, center=false, $fn=24);
        translate([0, 0, 1457.96]) rotate([-90, 0, 0]) cylinder(d=6.50, h=76.84, center=false, $fn=24);
        translate([0, 0, 1619.70]) rotate([-90, 0, 0]) cylinder(d=6.50, h=76.84, center=false, $fn=24);
    }
}
